                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto w-100 justify-content-end">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#WhyR3P">Why GPT X-AI?</a>
                                </li>
                                <li class="nav-item">
                                </li>
                            </ul>
                        ...
                        <a href="https://www.pinksale.finance/launchpad/0x0028CFa1e3870783218A53543783d66CA9990Bc6?chain=BSC"
                            class="button bt-white iq-mt-3 iq-ml-6">Get GPT X-AI </a>
                        ...
                        <div class="row flex-row-reverse">
                            ...
                            <div class="col-lg-5 align-self-center">
                                <div class="banner-text text-left iq-font-white">
                                    <h1 class="iq-font-white iq-mb-20">GPT X-AI<b class="iq-font-yellow">&nbsp
                                            Experienced team that brought you an 50x in just two days! </b></h1>
                                    <a href="https://www.pinksale.finance/launchpad/0x0028CFa1e3870783218A53543783d66CA9990Bc6?chain=BSC"
